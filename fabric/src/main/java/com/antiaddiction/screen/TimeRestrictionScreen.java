...
public class TimeRestrictionScreen extends Screen {
    ...
    private String line2, line3, line4;
    private int btnY, btnH;
    private int boxX, boxY, boxW, boxH;
    private int lineH, accentY;
    ...
    protected void init() {
        ...
        int contentH = boxH;
        int btnAreaH = 36;
        int totalH = titleH + 14 + contentH + 10 + btnAreaH;
    ...
    private void checkAndProceed() {
        ...
        if (PlayTimeChecker.isPlayAllowed()) {
            ...
            if (this.client != null && savedBgmVolume > 0) {
                this.client.options.getSoundVolumeOption(SoundCategory.MUSIC).setValue(savedBgmVolume);
            }
            assert this.client != null;
