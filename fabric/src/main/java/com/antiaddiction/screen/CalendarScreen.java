...
public class CalendarScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawCenteredTextWithShadow(this.textRenderer, title, titleX, titleY, C_WHITE);
        ...
        ctx.fill(legX, dotY1, legX + dotSize, dotY1 + dotSize, C_GREEN);
        String t1 = "可玩日";
        int c1 = legX + dotSize + dotTextGap + this.textRenderer.getWidth(t1) / 2;
        ctx.drawCenteredTextWithShadow(this.textRenderer, t1, c1, legY, C_MUTED);

        int legY2 = legY + lineH + 3;
        int dotY2 = legY2 + lineH / 2 - dotSize / 2;
        ctx.fill(legX, dotY2, legX + dotSize, dotY2 + dotSize, C_ORANGE);
        String t2 = "限时可玩日";
        int c2 = legX + dotSize + dotTextGap + this.textRenderer.getWidth(t2) / 2;
        ctx.drawCenteredTextWithShadow(this.textRenderer, t2, c2, legY2, C_MUTED);

        int legY3 = legY2 + lineH + 3;
        int dotY3 = legY3 + lineH / 2 - dotSize / 2;
        ctx.fill(legX, dotY3, legX + dotSize, dotY3 + dotSize, C_RED);
        String t3 = "调休非玩日";
        int c3 = legX + dotSize + dotTextGap + this.textRenderer.getWidth(t3) / 2;
        ctx.drawCenteredTextWithShadow(this.textRenderer, t3, c3, legY3, C_MUTED);
